...
console.log(`|                                                       |`);
console.log(`|=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=|`);
    client.user.setGame(`T-help| ON ${client.guilds.size}  Servers `, "http://twitch.tv/Streammingg")
...
T-add-wlc ⇏ لتفعيل خاصية الترحيب بالسيرفر
T-clear ⇏ لمسح الشات
...
client.on('message', msg => {
  if(msg.content === 'T-add-wlc')
  msg.reply(':envelope: | تم اضافة خاصية الترحيب بنجاح')
});
client.on('message', message => {
...
setInterval(function(){
client.channels.find('id', '489049740303007744').setName("🌺W");
client.channels.find('id', '489049740303007744').setName("🌺We");
client.channels.find('id', '489049740303007744').setName("🌺Wel");
client.channels.find('id', '489049740303007744').setName("🌺Welc");
client.channels.find('id', '489049740303007744').setName("🌺Welco");
client.channels.find('id', '489049740303007744').setName("🌺Welcom");
client.channels.find('id', '489049740303007744').setName("🌺Welcome");
client.channels.find('id', '489049740303007744').setName("🌺Welcome T");
client.channels.find('id', '489049740303007744').setName("🌺Welcome To");
client.channels.find('id', '489049740303007744').setName("🌺Welcome To T");
client.channels.find('id', '489049740303007744').setName("🌺Welcome To Ti");
client.channels.find('id', '489049740303007744').setName("🌺Welcome To Ti🌺");
  }, 3000);
});
	client.on('message', msg => {
